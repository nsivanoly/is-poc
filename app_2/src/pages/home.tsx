...
import APPLICATION_2 from "../images/mdu.png";
                ...
                (state.isAuthenticated) ?
                    <>
                        <div className="header-title">
                            <h1>
                                MDU My Membership Portal
                        </h1>
                        </div>
                        <div className="content">
                            <h2>Join the UK's leading medical defence organisation</h2>
                            <button
                        ...
                        <>
                            ...
                            <div className="content">
                                <div className="home-image">
                                    <img src={APPLICATION_2} className="react-logo-image logo" />
                                </div>
                                <button
